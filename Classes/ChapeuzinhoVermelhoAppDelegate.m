//
//  ChapeuzinhoVermelhoAppDelegate.m
//  ChapeuzinhoVermelho
//
...
@implementation ChapeuzinhoVermelhoAppDelegate

@synthesize window, initialScreen;
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {    
	...
	InitialScreenController *aview = [[InitialScreenController alloc] initWithNibName:@"InitialScreen" bundle:nil];
	self.initialScreen = aview;
	[window addSubview:initialScreen.view];
	[aview release];
    return YES;
