...
@implementation InitialScreenController

-(IBAction)swapViews:(id)sender{
	ChapeuzinhoVermelhoAppDelegate *delegate = (ChapeuzinhoVermelhoAppDelegate *)[[UIApplication sharedApplication] delegate];
	RecSpeechController *recSpeech = [[RecSpeechController alloc] initWithNibName:@"RecSpeechController" bundle:nil];
	[delegate switchViews:self.view toView:recSpeech.view];
}
